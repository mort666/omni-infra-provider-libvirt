...
func (x *AdditionalDisk) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AdditionalDisk) ProtoMessage() {}

func (x *AdditionalDisk) ProtoReflect() protoreflect.Message {
	mi := &file_specs_specs_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use AdditionalDisk.ProtoReflect.Descriptor instead.
func (*AdditionalDisk) Descriptor() ([]byte, []int) {
	return file_specs_specs_proto_rawDescGZIP(), []int{0}
}

func (x *AdditionalDisk) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *AdditionalDisk) GetVolName() string {
	if x != nil {
		return x.VolName
	}
	return ""
...
func (x *NetworkInterfaces) GetDriver() string {
	if x != nil {
		return x.Driver
	}
	return ""
...
func (x *NetworkInterfaces) GetNetwork() string {
	if x != nil {
		return x.Network
	}
	return ""
...
func (x *MachineSpec) GetAdditionalDisks() []*AdditionalDisk {
	if x != nil {
...
func (x *MachineSpec) GetNetworkInterfaces() []*NetworkInterfaces {
	if x != nil {
...
func (x *MachineSpec) GetCidataVolName() string {
	if x != nil {
		return x.CidataVolName
	}
	return ""
}
...
var file_specs_specs_proto_goTypes = []any{
	(*AdditionalDisk)(nil),    // 0: emuspecs.AdditionalDisk
	(*NetworkInterfaces)(nil), // 1: emuspecs.NetworkInterfaces
	(*MachineSpec)(nil),       // 2: emuspecs.MachineSpec
}
var file_specs_specs_proto_depIdxs = []int32{
	0, // 0: emuspecs.MachineSpec.additional_disks:type_name -> emuspecs.AdditionalDisk
	1, // 1: emuspecs.MachineSpec.network_interfaces:type_name -> emuspecs.NetworkInterfaces
