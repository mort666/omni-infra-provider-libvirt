...
#
# Generated on 2026-06-01T07:37:26Z by kres 8085f7d.
...
RUN --mount=type=cache,target=/root/.cache/go-build,id=omni-infra-provider-libvirt/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=omni-infra-provider-libvirt/go/pkg go install github.com/shanduur/dis-vulncheck@${DIS_VULNCHECK_VERSION} \
...
WORKDIR /src
RUN --mount=type=cache,target=/root/.cache/go-build,id=omni-infra-provider-libvirt/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=omni-infra-provider-libvirt/go/pkg dis-vulncheck -tool=false ./...
...
ARG GO_GCFLAGS
ARG GO_LDFLAGS
RUN --mount=type=cache,target=/root/.cache/go-build,id=omni-infra-provider-libvirt/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=omni-infra-provider-libvirt/go/pkg GOARCH=amd64 GOOS=darwin go build ${GO_BUILDFLAGS} -gcflags "${GO_GCFLAGS}" -ldflags "${GO_LDFLAGS}" -o /omni-infra-provider-libvirt-darwin-amd64
...
ARG GO_GCFLAGS
ARG GO_LDFLAGS
RUN --mount=type=cache,target=/root/.cache/go-build,id=omni-infra-provider-libvirt/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=omni-infra-provider-libvirt/go/pkg GOARCH=arm64 GOOS=darwin go build ${GO_BUILDFLAGS} -gcflags "${GO_GCFLAGS}" -ldflags "${GO_LDFLAGS}" -o /omni-infra-provider-libvirt-darwin-arm64
...
ARG GO_GCFLAGS
ARG GO_LDFLAGS
RUN --mount=type=cache,target=/root/.cache/go-build,id=omni-infra-provider-libvirt/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=omni-infra-provider-libvirt/go/pkg GOARCH=amd64 GOOS=linux go build ${GO_BUILDFLAGS} -gcflags "${GO_GCFLAGS}" -ldflags "${GO_LDFLAGS}" -o /omni-infra-provider-libvirt-linux-amd64
...
ARG GO_GCFLAGS
ARG GO_LDFLAGS
RUN --mount=type=cache,target=/root/.cache/go-build,id=omni-infra-provider-libvirt/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=omni-infra-provider-libvirt/go/pkg GOARCH=arm64 GOOS=linux go build ${GO_BUILDFLAGS} -gcflags "${GO_GCFLAGS}" -ldflags "${GO_LDFLAGS}" -o /omni-infra-provider-libvirt-linux-arm64
