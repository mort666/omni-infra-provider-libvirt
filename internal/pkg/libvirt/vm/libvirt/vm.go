...
func New(libvirt *libvirt.Libvirt, logger *zap.Logger) *Manager {
	return &Manager{
		0,
		logger,
	libvirt,
...
func (m *Manager) Create(name string, cfg *vm.Config, disks []libvirtxml.DomainDisk, networks []libvirtxml.DomainInterface) error {

	domain := &libvirtxml.Domain{
		Name:        name,
		Type:        "kvm",
		UUID:        cfg.Uuid,
		Description: "omni-infra-provider-libvirt",
	...
	m.logger.Debug("domain XML", zap.String("xml_data", xml))
